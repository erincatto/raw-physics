...
void graphics_renderer_debug_points(vec3* points, int point_count, vec4 color) {
	...
	for (s32 i = 0; i < point_count; ++i) {
		verts[i].position = {(r32)points[i].x, (r32)points[i].y, (r32)points[i].z};
		verts[i].color = {(r32)color.x, (r32)color.y, (r32)color.z, (r32)color.z};
	}
...
void graphics_renderer_debug_vector(vec3 p1, vec3 p2, vec4 color) {
	...
	verts[0].position = {(r32)p1.x, (r32)p1.y, (r32)p1.z};
	verts[0].color = {(r32)color.x, (r32)color.y, (r32)color.z, (r32)color.w};

	verts[1].position = {(r32)p2.x, (r32)p2.y, (r32)p2.z};
	verts[1].color = {(r32)color.x, (r32)color.y, (r32)color.z, (r32)color.w};

...
Mesh graphics_quad_create() {
	...
	v.position = { size, 0.0f, 0.0f };
	v.normal = { 0.0f, 0.0f, 1.0f };
	v.texture_coordinates = { 1.0f, 0.0f };
	array_push(vertices, v);

	v.position = { 0.0f, size, 0.0f };
	v.normal = { 0.0f, 0.0f, 1.0f };
	v.texture_coordinates = { 0.0f, 1.0f };
	array_push(vertices, v);

	v.position = { size, size, 0.0f };
	v.normal = { 0.0f, 0.0f, 1.0f };
	v.texture_coordinates = { 1.0f, 1.0f };
	array_push(vertices, v);

...
static Perspective_Camera create_camera() {
	...
	camera.rotation = {0.089766, 0.000000, 0.000000, 0.995981};
	camera.yrotation = {0.000000, 0.298214, 0.000000, 0.954520};
...
Example_Scene stack_example_scene = {
	.name = "Stack",
	.init = ex_stack_init,
